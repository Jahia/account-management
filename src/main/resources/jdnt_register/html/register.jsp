...
<form action="${url.baseLive}${currentNode.path}.register.do" method="post">
  <input type="hidden" name="redirectPage" value="${currentNode.properties['redirectPage'].node.path}"/>
  <div class="form-group">
    <label for="usernameInput"><fmt:message key="form.input.username"/></label>
    <input type="text" name="username" class="form-control" id="usernameInput" placeholder="john.smith">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="email" name="email" class="form-control" id="emailInput" aria-describedby="emailHelp" placeholder="john.smith@mail.com">
